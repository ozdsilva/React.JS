    ...
    return(
        <header className="pb-3 mb-4 border-bottom">
            <a href="/" className="d-flex align-items-center text-body-emphasis text-decoration-none">
              ...
              <span className="fs-4">Curso React</span>
            </a>
        </header>
    )
}
...
function Contador(props){
    ...
    //EFEITO COLATERAL SOMENTE NA MONTAGEM
    React.useEffect(()=>{
        console.log('ATIVOU EFEITO COLATERAL NA MONTAGEM')
    },[])
    ...
    if(props.tema == "dark") {
        return (
            <div className="h-100 p-5 text-bg-dark rounded-3">
                ...
                <button className="btn btn-outline-light" type="button">Clique aqui</button>
            </div>
        )
    }
    return (
